...
# Load a DNG file and convert it to an RGB image
...
# Measure mean and standard deviation of pixel values in a region
...
if __name__ == "__main__":
    ...
    # Load the main and telephoto DNG images
    main_img = load_dng_as_rgb("maincamera.dng")
    tele_img = load_dng_as_rgb("telephotocamera.dng")

    # Define a region of interest (ROI) to analyze noise
    roi = (100, 100, 50, 50)  

    # Compute noise stats for both cameras
    ...
    # Draw rectangles on the ROI for visualization
    ...
    # Display both images with ROI highlighted
